...
const OrderForm: React.FC = () => {
  ...
  const chooseDelivery = (check: boolean, val: ValueType<DeliveryType>) =>
    setDelivery(val);
  const choosePayment = (check: boolean, val: ValueType<PaymentType>) =>
    setPayment(val);
        ...
        <OrderWrap className="grid grid-3 grid-tb-1">
          <div>
            <form onSubmit={handleSubmit(onSubmitOrder)} autoCorrect="false">
              ...
              <OrderFormWrap
                className="grid grid-2 grid-mb-1"
              ...
              >
                  ...
                  <div className="grid grid-2 grid-mb-1">
                    ...
                    <div>
                      <FormInput
                        ...
                        expand
                        valid={register("phone", { required: ERROR_TEXT })}
                      ...
                      <>
                        <div>
                          <FormInput
                            ...
                            expand
                            valid={register("inn", { required: ERROR_TEXT })}
                ...
                <OrderSection className="order-deliver">
                  ...
                  {delivery === "pickup" && (
                    <Alert color="success">
                      <b>Адрес:</b> г.Тюмень, ул. Коммунистическая, 70, корп. 3,
                      стр. 6<br />
                    ...
                    <div className="grid grid-3 grid-mb-1">
                      <div>
                        <FormInput
                          placeholder="Город"
                          expand
                          valid={register("city", { required: ERROR_TEXT })}
                      ...
                      <div>
                        <FormInput
                          placeholder="Улица"
                          expand
                          valid={register("street", { required: ERROR_TEXT })}
                      ...
                      <div>
                        <FormInput
                          ...
                          expand
                          valid={register("address", { required: ERROR_TEXT })}
